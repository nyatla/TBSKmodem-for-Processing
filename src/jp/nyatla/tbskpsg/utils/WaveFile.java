...
public class WaveFile
{
	...
	{		
		this(parent,compatibility.toDoublePyIterator(frames),sample_rate,sample_bits);
	}
	public WaveFile(PApplet parent,float[] frames,int sample_rate)
	{		
		this(parent,compatibility.toDoublePyIterator(frames),sample_rate,16);
	}
	...
	public float[] getFrame() {
		...
		List<Double> d=this._pcmdata.dataAsFloat();
